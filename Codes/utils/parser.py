...
def parse_args():
    ...
    # ===== dataset ===== #
    parser.add_argument("--dataset", nargs="?", default="beijing", help="Choose a dataset:[beijing, shanghai]")
    parser.add_argument(
    ...
    parser.add_argument("--rates",type=int, default=4, help='rating strategy')
    parser.add_argument("--scatter", type=str,default='mean', help='scatter strategy')
    parser.add_argument("--cr", type=bool,default=True,help='causal effect')
    # ===== relation context ===== #
